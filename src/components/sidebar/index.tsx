...
import { Home, HomeIcon, LineChart, Package, PanelBottom, Settings2, ShoppingBag, Users, Table, User, User2, Table2 } from "lucide-react";
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Link href="/tables" className="flex h-9 w-9 shrink-0 items-center justify-center text-primary-foreground rounded-full transition-transform duration-300 hover:-translate-y-1">
                  <Table className="h-5 w-5 text-black"></Table>
                  <span className="sr-only"> DashBoard Avatar</span>
                </Link>
              </TooltipTrigger>
            </Tooltip>
