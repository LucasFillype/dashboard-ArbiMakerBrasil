  ...
  return (
    <div>
      <div className="flex flex-row justify-center items-center py-4 gap-4 text-white border-zinc-700">
        ...
        <Button className="bg-green-500 border-none" variant="outline" onClick={() => setShowAddRow(!showAddRow)}>
          {showAddRow ? "Cancelar" : "Adicionar"}
        </Button>
        <Button
          variant="outline"
          className={isDeleteMode ? "bg-red-600 text-white border-none" : "bg-red-500 border-none"}
          onClick={() => setIsDeleteMode(!isDeleteMode)}
        >
          {isDeleteMode ? "Cancelar Exclusão" : "Excluir"}
        </Button>
        {isDeleteMode && (
          <div className="flex justify-center mt-2 border-none">
            <Button
