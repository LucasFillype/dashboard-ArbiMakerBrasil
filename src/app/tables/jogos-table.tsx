...
export function TabelaJogos<TData, TValue>({
  columns,
  data,
  ...
  return (
    <div>
      <div className="flex flex-row justify-center items-center py-4 gap-4 text-white border-zinc-700">
        ...
        <Button className="bg-green-500" variant="outline" onClick={() => setShowAddRow(!showAddRow)}>
          {showAddRow ? "Cancelar" : "Adicionar"}
        </Button>
        <Button
          variant="outline"
          className={isDeleteMode ? "bg-red-600 text-white" : "bg-red-500"}
          onClick={() => setIsDeleteMode(!isDeleteMode)}
        >
          {isDeleteMode ? "Cancelar Exclusão" : "Excluir"}
        </Button>
        {isDeleteMode && (
      ...
      <div className="rounded-md border border-zinc-700 w-full max-w-6xl mx-auto text-white">
        <Table>
          <TableHeader>
